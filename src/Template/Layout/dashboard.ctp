...
<html>
	<head>
		...
		<?php  
			...
			echo $this->Html->script(array( 'jquery.min.js','jquery.easing.1.3.js','bootstrap.min.js','jquery.waypoints.min.js','owl.carousel.min.js',
					...
					<div class="row">
						...
						<div class="col-xs-10 text-right menu-1 main-nav">
							<ul>
								...
								<li><a href="logout" data-nav-section="logout"  class="external">Sign Out</a></li>
							</ul>
						</div>
					</div>
				</div>
			...
			<div id = "page-wrapper">		
				<nav class="gtco-nav" role=" navigation" style = "position: relative; z-index: 0;">	
					<div id = "menu" class="main-nav">
						<ul>
							<li class = "active"><a href="dashboard" data-nav-section="dashboard"  class="external">Dashboard</a></li>
							<li><a href="exchange" data-nav-section="trade" class="external">Exchange</a></li>
							<li><a href="deposit" data-nav-section="deposit" class="external">Deposit</a></li>
							<li><a href="withdraw" data-nav-section="withdraw" class="external">Withdraw</a></li>
							<li><a href="orders" data-nav-section="orders"  class="external">Orders</a></li>
							<li><a href="change_password" data-nav-section="change_password"  class="external">Change Password</a></li>
						</ul>
					</div>
				</nav>
					...
					<div class="row copyright">
						<div class="col-md-12">
							<p class="pull-left">
								...
								<small class="block">
									Designed by <a href="http://gettemplates.co/" target="_blank">GetTemplates.co</a>
